//
//  CLLCommonDefinition.h
//  AppBasic
//
//  Created by leocll on 2017/11/24.
//  Copyright © 2017年 leocll. All rights reserved.
//  ⚠️⚠️⚠️⚠️⚠️用于定义常用宏，可跨项目使用⚠️⚠️⚠️⚠️⚠️

#ifndef CLLCommonDefinition_h
#define CLLCommonDefinition_h
...
#define kScaleRatioFont (kScreenWidthScale6>1.0?1:(kScreenWidthScale6<1.0?-1:0))
// 适配大小 iPhone6 pt
#define kViewSize6(Size) ((Size)*kScaleRatio)
#define kFontPointSize6(Size) ((Size)+kScaleRatioFont)
